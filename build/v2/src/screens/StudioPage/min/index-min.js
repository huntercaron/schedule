...
class StudioPage extends Component {
    ...
    render() {
        return _jsx(Wrapper, {}, void 0, _jsx(HeaderArea, {
            text: this.props.studio.facultyClass
        }, void 0, _jsx(StudioInfo, {
            studio: this.props.studio
        })), _jsx(DateSelector, {
            selectedDate: this.grabNewDate(),
            onSelectedDateChange: this.handleSelectedDate
        }), _jsx(CalendarBox, {}, void 0, _ref, _jsx(CalendarBody, {
            studio: this.props.studio,
            selectedDate: this.grabNewDate()
        })));
    }
